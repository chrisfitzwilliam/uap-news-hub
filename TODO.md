...
- [x] Publish seven evidence-first, primary-source-linked baseline articles.
- [ ] Add new reporting only through the configured validation and review gates; preserve the queued Burlison candidate until it has a `small` model transcript and independent corroboration.
