...
- Live launch state (2026-07-10): `main` is published at `https://github.com/chrisfitzwilliam/uap-news-hub`; Actions deploys `https://chrisfitzwilliam.github.io/uap-news-hub/` with the `UAPNEWSHUB_SITE_URL` repository variable set and HTTPS enforced.
